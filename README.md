...
> This project applies code and methodology developed in the course **Modelling Financial Risk with R**, taught by dr Dr Rafał Chmura at SGH Warsaw School of Economics (2026). The R scripts are adapted from course materials. Analysis and interpretation are applied independently to XAU/USD data.
